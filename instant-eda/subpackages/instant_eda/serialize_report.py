...
from instant_eda.report.presentation.core import Root
    ...
    def loads(self, data: bytes, ignore_config: bool = False):
        ...
        if (df_hash == self.df_hash) and (
            ...
            if (
                ...
                and loaded_description_set["package"]["instant_eda_version"]
                != __version__
            ):
                warnings.warn(
                    f"The package version specified in the loaded data is not equal to the version installed. "
                    f"Currently running on instant_eda {__version__} , while loaded data is generated by instant_eda, {loaded_description_set['package']['instant_eda_version']}."
                )
