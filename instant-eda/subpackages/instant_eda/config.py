...
from instant_eda.utils.paths import get_config_default
...
class Config(object):
    ...
    _shorthands = {
        ...
        "duplicates": {"head": 0},
        "scatter_interactions": {"targets": [], "continuous": False},
        "missing_interactions": {"missing": False},
        "time_series": {"targets": [], "datetime": False},
        "missing_diagrams": {
            "bar": False,
            "matrix": False,
            "heatmap": False,
    ...
    def clear(self):
        self.config = confuse.Configuration("InstantEDA", __name__, read=False)
        self.set_file(str(get_config_default()))
