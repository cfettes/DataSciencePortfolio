...
from instant_eda.report.formatters import get_fmt_mapping

# Initializing Jinja
from instant_eda.utils.paths import get_html_template_path

package_loader = PackageLoader(
    "instant_eda", "report/presentation/flavours/html/templates"
)
