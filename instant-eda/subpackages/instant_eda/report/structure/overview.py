...
from instant_eda.report.presentation.core import Container, Table, Warnings
...
def get_dataset_reproduction(summary: dict):
    #version = summary["package"]["instant_eda_version"]
    #config = quote(summary["package"]["instant_eda_config"])
